...
const ContestCard: React.FC<ContestCardProps> = ({ data }) => {
  return (
    <div className="min-h-screen flex items-start justify-center bg-[#B8E1B0] py-12 px-4">
      <div className="w-full max-w-2xl px-6 py-8 rounded-2xl bg-black border-2 border-[#3F5E3B] shadow-lg transition-transform duration-200 hover:scale-[1.02] mt-8">
        {/* Title */}
