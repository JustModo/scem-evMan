...
export default function TestSessionPage() {
  ...
  }, [id, session, questions, selectedLangs]);
  ...
  return (
    <div className="flex flex-col h-screen bg-background overflow-hidden">
      <header className="h-14 border-b bg-card px-6 flex items-center justify-between shrink-0 shadow-sm z-10">
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="w-16 md:w-64 border-r bg-card flex flex-col shrink-0">
